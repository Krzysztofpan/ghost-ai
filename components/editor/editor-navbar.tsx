  ...
  return (
    <header className='flex h-14 items-center border-b border-surface-border bg-surface px-3'>
      <div className='flex flex-1 items-center'>
        <Button type='button' variant='ghost' size='icon' onClick={onSidebarToggle} aria-label={isSidebarOpen ? "Close sidebar" : "Open sidebar"} className='text-copy-secondary hover:bg-subtle hover:text-copy-primary'>
