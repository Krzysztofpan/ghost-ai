        ...
        <Tabs defaultValue="my-projects" className="flex min-h-0 flex-1 flex-col p-4">
          ...
          >
            {ownedProjects.length === 0 ? (
              <div className="flex flex-1 items-center justify-center rounded-2xl border border-dashed border-surface-border-subtle bg-surface px-4 text-center text-sm text-copy-muted">
