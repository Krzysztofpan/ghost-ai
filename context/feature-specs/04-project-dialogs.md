...
Build the `/editor` home screen and add project dialogs/sidebar actions. No API calss or persistence yet.
...
Keep the layout minial. Do not wrap this content in cards.
